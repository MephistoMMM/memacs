(custom-set-variables
 ...
 '(auth-sources (quote ("~/Dropbox/dotconf/authinfo.gpg" "~/.authinfo.gpg" "~/.netrc")))
 '(beacon-color "gold")
 '(beacon-mode t)
 '(counsel-mode t)
