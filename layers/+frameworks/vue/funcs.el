...
(defun spacemacs//vue-setup-keybindings ()
  ...
  (spacemacs/declare-prefix-for-mode 'vue-mode "=" "format")
  (spacemacs/declare-prefix-for-mode 'vue-mode "E" "errors")
  (spacemacs/declare-prefix-for-mode 'vue-mode "e" "element")
  (spacemacs/declare-prefix-for-mode 'vue-mode "g" "goto")
  (unless (equal vue-backend 'lsp)
    (spacemacs/declare-prefix-for-mode 'vue-mode "h" "help")
