...
(defun spacemacs/show-hide-helm-or-ivy-prompt-msg (msg sec)
  "Show a MSG at ivy prompt for SEC.
...
(defun memacs/define-evil-keybinding (states key def &rest bindings)
  "Binding keys and func for states map."
  (while key
    (mapcar (lambda (state) (define-key state (kbd key) def)) states)
