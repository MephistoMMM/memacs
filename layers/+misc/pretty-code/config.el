...
(defvar memacs-company-box-icons-all-the-icons-org-list
  '((Unknown . (all-the-icons-faicon "question-circle" :height 1                                   ))
    (Text . (all-the-icons-faicon "text-height"        :height 1                                   ))
    (Method . (all-the-icons-faicon "tag"              :height 1 :face font-lock-function-name-face))
    (Function . (all-the-icons-faicon "tag"            :height 1 :face font-lock-function-name-face))
    ...
    (Interface . (all-the-icons-faicon "puzzle-piece"  :height 1 :face font-lock-preprocessor-face ))
    (Module . (all-the-icons-alltheicon "less"         :height 1 :face font-lock-preprocessor-face ))
    (Property . (all-the-icons-faicon "cog"            :height 1 :face font-lock-builtin-face      ))
    (Unit . (all-the-icons-faicon "wrench"             :height 1                                   ))
