...
(defvar memacs-company-box-icons-all-the-icons-org-list
  '((Unknown . (memacs/company-box-icon octicon "file-text"))
    (Text . (memacs/company-box-icon faicon "file-text-o"))
    (Method . (memacs/company-box-icon faicon "cube"))
    (Function . (memacs/company-box-icon faicon "cube"))
    (Constructor . (memacs/company-box-icon faicon "cube"))
    (Field . (memacs/company-box-icon faicon "tag"))
    (Variable . (memacs/company-box-icon faicon "tag"))
    (Class . (memacs/company-box-icon faicon "cog"))
    (Interface . (memacs/company-box-icon faicon "cogs"))
    (Module . (memacs/company-box-icon alltheicon "less"))
    (Property . (memacs/company-box-icon faicon "wrench"))
    (Unit . (memacs/company-box-icon faicon "tag"))
    (Value . (memacs/company-box-icon faicon "tag"))
    (Enum . (memacs/company-box-icon faicon "file-text-o"))
    (Keyword . (memacs/company-box-icon material "format_align_center"))
    (Snippet . (memacs/company-box-icon material "content_paste"))
    (Color . (memacs/company-box-icon material "palette"))
    (File . (memacs/company-box-icon faicon "file"))
    (Reference . (memacs/company-box-icon faicon "tag"))
    (Folder . (memacs/company-box-icon faicon "folder"))
    (EnumMember . (memacs/company-box-icon faicon "tag"))
    (Constant . (memacs/company-box-icon faicon "tag"))
    (Struct . (memacs/company-box-icon faicon "cog"))
    (Event . (memacs/company-box-icon faicon "bolt"))
    (Operator . (memacs/company-box-icon faicon "tag"))
    (TypeParameter . (memacs/company-box-icon faicon "cog"))
    (Template . (memacs/company-box-icon octicon "file-code")))
