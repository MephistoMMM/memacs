...
(defun spacemacs//lsp-declare-prefixes-for-mode (mode)
  ...
  (unless (member mode lsp-layer--active-mode-list)
    ...
    (spacemacs/declare-prefix-for-mode mode "a" "code actions")
    (spacemacs/declare-prefix-for-mode mode "b" "backend")
    (spacemacs/declare-prefix-for-mode mode "F" "folder")
    (spacemacs/declare-prefix-for-mode mode "g" "goto")
    (spacemacs/declare-prefix-for-mode mode "G" "peek")
    ...
    (spacemacs/declare-prefix-for-mode mode "x" "text/code")
    (dolist (prefix '("g" "G"))
