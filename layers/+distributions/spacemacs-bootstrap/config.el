...
(defvar spacemacs-evil-cursors
  '(("normal" (face-attribute 'font-lock-constant-face :foreground) box)
    ("insert" (face-attribute 'font-lock-function-name-face :foreground) (bar . 2))
    ("emacs" (face-attribute 'font-lock-type-face :foreground) box)
    ("hybrid" (face-attribute 'font-lock-function-name-face :foreground) (bar . 2))
    ("replace" (face-attribute 'font-lock-warning-face :foreground) (hbar . 2))
    ("evilified" (face-attribute 'font-lock-constant-face :foreground) box)
    ("visual" (face-attribute 'font-lock-string-face :foreground) (hbar . 2))
    ("motion" (face-attribute 'font-lock-warning-face :foreground) box)
    ("lisp" "HotPink1" box)
