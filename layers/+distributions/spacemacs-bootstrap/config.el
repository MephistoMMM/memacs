...
(defvar spacemacs-evil-cursors
  '(("normal" (face-attribute 'font-lock-constant-face :foreground) box)
    ("insert" (face-attribute 'font-lock-string-face :foreground) (bar . 2))
    ("emacs" (face-attribute 'font-lock-builtin-face :foreground) box)
    ("hybrid" (face-attribute 'font-lock-string-face :foreground) (bar . 2))
    ...
    ("visual" (face-attribute 'font-lock-type-face :foreground) (hbar . 2))
    ("motion" (face-attribute 'font-lock-keyword-face :foreground) box)
    ("lisp" "HotPink1" box)
