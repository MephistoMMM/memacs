...
;;;###autoload
(defun +company/company-box-icons--tabnine (candidate)
  (when (eq (get-text-property 0 'company-backend candidate)
            'company-tabnine)
    'Reference))

;;;###autoload
(defun +company/company--transform-candidates (func &rest args)
...
;;;###autoload
(defun +company/company-tabnine (func &rest args)
